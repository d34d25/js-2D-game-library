...
const obstacleA = physics.createBodyBox({position: {x:220, y: 550}, size: {w:50,h:50}, isStatic: true, noRotation:true,dynamicFriction: 0, staticFriction:0}); //, staticFriction:0, dynamicFriction:0});
...
const PHYSWORLD = new physics.PhysWorld([testEntity.body,testEntityB.body,testEntityC.body, FLOOR, obstacleA, obstacleB, obstacleC], {x:0, y:150});

//PHYSWORLD.bodies.push(testEntityB.body);
//PHYSWORLD.bodies.push(testEntity.body);
//PHYSWORLD.bodies.push(testEntityC.body);
